...
nombre.innerHTML = nombre.innerHTML + " Santiago" //O creo una variable para almacenar el nombre y la concateno
...
function addToDo() {
  // Tu código acá:
  var value = document.getElementById('toDoInput').value //Guardo el valor del input
...
.addEventListener('click', addToDo)
                                        /*La funcion va sin () porque solo se invoca cuando hay un 'click', 
                                        si le pongo () se invoca siempre*/
...
function completeToDo(event) {
  ...
  //Paso 3 se realiza en buildToDo()
}
